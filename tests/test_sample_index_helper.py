...
from src.fast_scboot.c.sample_index_helper import make_index_matrix, count_clusts
...
def test_count_clusts():
	...
	array = np.squeeze(np.dstack([strats, clusts, clusts, clusts, clusts])).astype(np.int32)
