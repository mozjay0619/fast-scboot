...
if USE_CYTHON:
    ext_modules += [
        Extension('fast_scboot.c.tuple_hash_function', ['src/fast_scboot/c/tuple_hash_function.pyx'], **opts),
        Extension('fast_scboot.c.utils', ['src/fast_scboot/c/utils.pyx'], **opts),
        Extension('fast_scboot.c.sample_index_helper', ['src/fast_scboot/c/sample_index_helper.pyx'], **opts),
    ...
    ext_modules += [
        Extension('fast_scboot.c.tuple_hash_function', ['src/fast_scboot/c/tuple_hash_function.c'], **opts),
        Extension('fast_scboot.c.utils', ['src/fast_scboot/c/utils.c'], **opts),
        Extension('fast_scboot.c.sample_index_helper', ['src/fast_scboot/c/sample_index_helper.c'], **opts),
